...
target_folder = 'export_old_ü40'

doc_name = 'Spielberichte_Ü40.docx'

document = Document()

document.add_heading('Spielberichte Traktor Ü40', 0)
...
os.chdir(r'D:\Code\traktor_spielberichte\export_old_ü40')


url = 'http://s600778792.online.de/ue-40-vergangene-saisons'
