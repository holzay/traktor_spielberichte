...
'Landesliga 1 | Saison 2011/2012' : '2011-2012_Landesliga_1',
'Saison 2010/211' : '2010-2011_Saison',
'Saison 2009/2010' : '2009-2010_Saison',
'Saison 2008/2009' : '2008-2009_Saison'
}

target_folder = 'export_old_mannschaft_2'

doc_name = 'Spielberichte_alt_Mannschaft_2.docx'

document = Document()

document.add_heading('Spielberichte Mannschaft II', 0)
...
os.chdir(r'D:\Code\traktor_spielberichte\export_old_mannschaft_2')


url = 'http://s600778792.online.de/ii-mannschaft-vergangene-saisons'
